...
<br><br><input type='checkbox' class='checkbox' name='subacc' value='1' checked> Показать статистику по субаккаунтам (каналам)
...
<?=H::moredivAll ('таблицу статистики по товарам','bb') ?>
...
<table align="center" cellspacing="0">
    ...
    <tr>
        <td style="font-size:9px"><?=$one->title?></td>
    ...
    <tr>
        <?php $cl = $totalstat ?>
        <td style="font-size:9px"><b>Все товары (включая скрытые)</b></td>
        <td class="thedate"><?=$cl['clicks']?></td>
        <td><?=$cl['waiting']?></td>
        <td class="gooddate"><?=$cl['approved']?></td>
        <td class="gooddate"><?=$cl['processing']?></td>
...
<fieldset>
    ...
    <ol>
        ...
        <li>
            <label>Всего засчитано продаж:</label><?=count($opaid)?>
...
<div class='wrap'>
    ...
    <h1>Статистика по субаккаунтам</h1>
