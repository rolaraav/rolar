...
<ul id="navlist" class="dropdown">
    ...
    <li><a style='margin-left: 12px;' href="<?php echo 'https://ordermaster.ru/help2/'.str_replace ('/','_',Yii::app()->controller->id.'_'.$this->action->id).'.html'; ?>" target='_blank'><?=H::menuimg('help'); ?></a>
</ul>        
    ...
    <td width="215" valign="top">
      ...
      $sitems = array_merge (array(
        ...
        'url'=>'https://ordermaster.ru/help/'.str_replace ('/','_',Yii::app()->controller->id.'_'.$this->action->id).'.html',
...
<div id="copyright">
Программное обеспечение: &quot;<a href="https://ordermaster.ru" target="_blank">Order Master 2</a>&quot;. &copy; 2003-<?=date('Y');?>
</div>
