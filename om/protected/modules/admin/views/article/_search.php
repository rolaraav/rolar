...
<ol>
	...
	<li>
		...
		<?php echo $form->dropDownList($model,'category_id',ArticleCategory::items (), array('class'=>'text', 'empty' => '')); ?>
	</li>
	...
	<li>
		...
		<?php echo $form->textArea($model,'content',array('rows'=>6, 'cols'=>50, 'class' => 'textarea')); ?>
	</li>
