...
<li>
<label>Автор:</label>
<div class="vidvalue"><?= ($answer->kind == 'staff')?$answer->staff->firstName.' (оператор)':'Пользователь'; ?></div>
</li>

<li>
<label>Дата:</label>
<div class="oneitem"><span class="date"><?= date ('d.m.Y H:i', $answer->updateTime); ?></span>

&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  <?= CHtml::link ('[Удалить этот ответ]', array ('delete','id' => $answer->id, 'a' => 1)); ?></div>
</li>
