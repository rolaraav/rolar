<?php /* source file: D:\YandexDisk\OpenServer\domains\test\om\protected\modules\admin\views/layouts/login.php */ ?>
<html>
<head>
...
<div id="copyright">
Программное обеспечение: Order Master 2 &copy; <?= date('Y'); ?>
</div>
<br />
