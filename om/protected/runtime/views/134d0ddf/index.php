<?php /* source file: D:\YandexDisk\OpenServer\domains\localhost\om\protected\views\order\index.php */ ?>
...
<h2>Стоимость: <?php
    ...
    ?><?=H::mysum($good->price).H::valuta($good->currency) ?></h2>
...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    'htmlOptions' =>
        array (
            'onSubmit' => 'if(confirm("Вы подтверждаете правильность введённых Вами данных?")) return true; else return false;'
         ),
...
<?php endif; ?>
    ...
    <li>
        ...
        <?= $form->textField($model,'cupon',array('size'=>60,'maxlength'=>255, 'class' => 'text','disabled' => (!empty ($cupon)))); ?>
