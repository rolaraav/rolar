<?php /* source file: D:\YandexDisk\OpenServer\domains\test\om\protected\modules\admin\views\settings/paysystems\_yandexkassa.php */ ?>
<fieldset>

    <legend>Параметры приёма платежей через Яндекс.Касса</legend>

    <img src="<?=Y::bu()?>images/admin/pay/yandexkassa.png" style="padding:20px 25px;">
