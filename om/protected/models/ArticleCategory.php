...
/**
 * This is the model class for table "op1_article_category".
 *
 * The followings are the available columns in table 'op1_article_category':
 * @property integer $id
...
class ArticleCategory extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'articles' => array(self::HAS_MANY, 'Article', 'category_id', 'condition' => 'visible = 1', 'order'=>'position ASC'),
			'articleCount' => array(self::STAT, 'Article', 'category_id', 'condition' => 'visible = 1'),
		);
	}
