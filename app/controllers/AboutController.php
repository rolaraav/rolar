...
class AboutController extends BaseController {
  ...
  public $balls; // скриншоты достижений

  public function indexAction() {
    //echo 'AboutController - метод indexAction()<br>';
    ...
    $path = 'images/about/';
      $files = 'diplom.jpg,dmsh15.jpg,ccna1.jpg,ccna2.jpg,ccna3.jpg,ccna4.jpg,4b.jpg,nova.jpg,novicam.jpg,upakovka_biznesa.jpg,elektromontazhnik.jpg,shulgan-tash.jpg,udostoverenie.jpg,neiroseti.png';
      $this->balls = get_screenshots($path,$files);
