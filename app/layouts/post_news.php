...
<div class="articleinfo">
    ...
    <i class="fa fa-list-alt green1" aria-hidden="true" title="Раздел"></i> <a href="<?=D.S.$post['alias_category'];?>" target="_self" title="<?=$post['title_category'];?>"><?=$post['title_category'];?></a>
</div>
<div class="blocktext">
<?php if (isset($image)) {
  echo $image;
...
<div class="articleinfo">
    ...
    <img src="<?=I.S;?>rating/yellow_stars<?=$post['rating'];?>.png" width="65px" height="13px">
</div>