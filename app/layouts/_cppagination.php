...
?>
<div class="cppaginal_navigation">
<div class="center">
<form action="" id="cpnum_change" method="post" target="_top">
  <div class="cpnum_select" id="cpnum_change">Отображать
  <select id="changeShow" name="cnum" target="_self" title="Выберите количество записей на странице">
    <option disabled="disabled" value="30">Выберите количество записей</option>
    ...
    <option value="200" <?php if ($quantity_posts == 200) {echo $sel;} ?>>200 записей на странице</option>
    <option value="500" <?php if ($quantity_posts == 500) {echo $sel;} ?>>500 записей на странице</option>
    <option value="999" <?php if ($quantity_posts > 999) {echo $sel;} ?>>все записи на странице</option>
  </select>
  <input class="button" id="cpnum_change_submit_button" name="cnum_change" type="submit" value="Выбрать">
  </div>
</form>
</div>
